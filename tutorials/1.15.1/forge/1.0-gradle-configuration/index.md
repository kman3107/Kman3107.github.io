...
First of all you need to change the version of your mod from `version = '1.0'` to `version = '1.15.1-0.1.0'`. Versioning in modding is in the format `MinecraftVersion-ModMajorVersion.ModMinorVersion.ModPatchVersion`. You can read more about versioning at [SemVer](https://semver.org).
