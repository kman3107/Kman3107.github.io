...
![build.gradle](/tutorials/1.14.3/forge/1.0-gradle-configuration/build-gradle.png "build.gradle")  

First of all you need to change the version of your mod from `version = '1.0'` to `version = '1.14.3-0.1.0'`. Versioning in modding is in the format `MinecraftVersion-ModMajorVersion.ModMinorVersion.ModPatchVersion`. You can read more about versioning at [SemVer](https://semver.org).
...
![Version](/tutorials/1.14.3/forge/1.0-gradle-configuration/version.png "Version")  
...
![modid](/tutorials/1.14.3/forge/1.0-gradle-configuration/modid.png "modid")  
...
![MCP Mappings](/tutorials/1.14.3/forge/1.0-gradle-configuration/mcp-mappings.png "MCP Mappings")  
...
![mods.toml](/tutorials/1.14.3/forge/1.0-gradle-configuration/toml0.png "mods.toml")  
![mods.toml](/tutorials/1.14.3/forge/1.0-gradle-configuration/toml1.png "mods.toml")
